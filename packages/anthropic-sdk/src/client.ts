...
/**
 * Returns a singleton JenzClient if JENZ_API_KEY is set; otherwise returns
 * null and prints a one-time warning. Subsequent calls reuse the cached
 * instance. Mirrors the same pattern as @jenz-ai/claude-agent-sdk so users
 * get the same "dormant by default" behaviour across adapters.
 */
